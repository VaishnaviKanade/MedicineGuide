...
<body class="brwsmdcn">
    <div class="header-area">
        <div class="header-top">
            <div class="container">
                <a href="cupanel.php"><img src="../img/client-1295901_960_720.png"
                        style="max-height: 5%;max-width: 5%;margin-left: 50%;opacity:1.0;"></a>
        ...
        <div id="sidebar">
            ...
            <?php
				if(isset($_SESSION['cart'])){
					...
					?>
            <p style="padding:7px;font-weight:bold;font-size:15px;"><?php echo $row['medName'] ?> x
                <?php echo $_SESSION['cart'][$row['medId']]['quantity'] ?></p>
            <?php
