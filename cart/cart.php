    ...
    <form method="post" action="index.php?page=cart">
        <table>
            ...
            <form class="col-md-4 col-sm-offset-4 text-center"
                style="margin: 2%;background-color: #e3e8ef;border: 1px #e3e8ef;border-radius: 5%; opacity:0.9;filter: alpha(opacity=60);text-align: center;margin-left: 35%;padding-top: 2%;padding-bottom: 2%;box-shadow: 5px 10px #989ba0;margin-top: 4%"
                ...
                <div class="form-group center">
                    ...
                    <input type="text" class="form-control" id="user" name="uname"
                        style="width:50%;margin-left: 24%;margin-top:-35px;" required>
                </div>
                <div class="form-group">
                    <label for="mbl" style="font-weight: bold;color: #000000;">Mobile:</label>
                    <input type="text" class="form-control" id="mbl" name="umobile"
                        style="width:50%;margin-left: 24%;margin-top:-35px;" required>
                </div>
                <div class="form-group">
                    <label for="adrs" style="font-weight: bold;color: #000000;">Address:</label>
                    <input type="text" class="form-control" id="adrs" name="uaddress"
                        style="width:50%;margin-left: 24%;margin-top:-35px;" required>
                </div>
                <div class="form-group center">
                    <label>Region:</label>
			...
			$sql="SELECT * FROM medicine WHERE medId IN (";
                ...
                <tr>
                    ...
                    <td><input type="text" name="quantity[<?php echo $row['medId'] ?>]" size="5"
                            value="<?php echo $_SESSION['cart'][$row['medId']]['quantity'] ?>" /></td>
                    <td>Rs.<?php echo $row['price'] ?></td>
                    <td>Rs.<?php echo $_SESSION['cart'][$row['medId']]['quantity']*$row['price'] ?></td>
                </tr>
